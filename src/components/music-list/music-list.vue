<template>
    <div class="music-list">
        ...
        <div class="bg-image" :style="bgStyle" ref="bgImage">
            <div @click="random" class="play-wrapper" ref="playWrapper" v-show="songs.length>0">
                <div class="play">
                    <i class="icon-play"></i>
        ...
        <Scroll @scroll="scroll" :listenScroll="listenScroll" :probeType="probeType" :data="songs" class="list"
            ...
            <div class="song-list-wrapper">
                <songList @songItem="songItem" :songs="songs"></songList>
            </div>
    ...
    export default{
        ...
        watch: {
            scrollY(newY){
                ...
                let zIndex = 0
                let scale = 1
                let percent = Math.abs(newY / this.imageHeight)  // scale计算公式
                let blur = 0
                // 往下拉
                if (newY > 0) {
                    scale += percent
